...
import 'package:smartpatient/core/state/conditions_provider.dart';
import 'package:smartpatient/core/state/medication_provider.dart';
import 'package:smartpatient/core/state/profile_provider.dart';
import 'package:smartpatient/core/utils/pdf_formatting_utils.dart';
...
class PdfExportService {
  ...
  Future<void> exportMedicationReport({
    ...
    try {
      ...
      // Save to file
      final file = await _savePdfToFile(pdfDoc);
  ...
  pw.Widget _buildFooter(DateTime exportDate) {
    return pw.Container(
      ...
      child: pw.Text(
        'This report was generated by SmartPatient on ${PdfFormattingUtils.formatDateForPdf(exportDate)}. '
  ...
  Future<void> _sharePdf(File file) async {
    try {
      final result = await Share.shareXFiles(
        [XFile(file.path)],
        subject: 'SmartPatient Medication Report',
        text: 'Medication report generated by SmartPatient',
      );
